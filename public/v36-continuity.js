...
const STUDIO_VERSION='v40.0.0-root',STUDIO_BUILD='2026.08.20-v40-vibrant-professional-pwa';
...
function releaseMatches(x){const legacy=x?.version===EXPECTED&&x?.buildId===BUILD;const studio=x?.productName==='Kosif'&&x?.version===STUDIO_VERSION&&x?.buildId===STUDIO_BUILD&&x?.experienceVersion==='v40.0.0'&&x?.installable===true;return legacy||studio}
