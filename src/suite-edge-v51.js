 ...
 * Keeps the governed v43 suite intact while adding recorder v51 routes and cache-busting the verified v51 client loader.
 */
...
function upgradeRecorderClient(response) {
  ...
  rewriter.on('#kosif-ux-session-recorder', {
    element(el) {
      el.setAttribute('src', '/responsive-preview-plugin.js?v=2026.08.22-v51-verified-save');
    }
  });
