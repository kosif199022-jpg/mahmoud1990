...
const SUITE={
  productName:'Kosif',
  version:'v40.0.0-root',
  buildId:'2026.08.20-v40-vibrant-professional-pwa',
  ...
  designAuthority:'KOSIF Studio v40 warm editorial system with governed cobalt, teal, coral, violet and gold accents',
  experienceVersion:'v40.0.0',
  installable:true,
...
export default{
  async fetch(req,env,ctx){
    ...
    if(p==='/__version')return json({...SUITE,legacyRelease:'v40.0-compatible'});
