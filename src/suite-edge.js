...
import { handleReconciliation } from './reconciliation-api.js';
...
export default{
  async fetch(req,env,ctx){
    ...
    if(p.startsWith('/api/kosif/v49/')){
      const r49=await handleReconciliation(req,u);if(r49)return sameOriginApi(r49,req);
    }
