...
const BUILD_INFO={version:'v36.3',buildId:'2026.08.17-v36.3-master-requirements',release:'Requirements Consolidation & Continuity + Z.ai',schemaVersion:13,appCache:'kosif-native-v36-3-app',standardsCache:'kosif-native-v36-3-standards',sourceRepo:'kosif199022-jpg/mahmoud1990',mobileNav:['الرئيسية','الميزان','الجولات','المطالبات','المزيد'],fontScale:{min:90,max:200},aiGate:'owner-password+verified-key',aiProviders:['gemini','openai','anthropic','zai']};
