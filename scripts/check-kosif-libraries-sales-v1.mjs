...
ok(proxy.includes("const requestedBook = String(requestUrl?.searchParams?.get('book')")&&proxy.includes("u.searchParams.set('book', requestedBook)"),'fallback reader redirects preserve the explicit allow-listed book selection');
