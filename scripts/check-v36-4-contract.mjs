...
ok('production enters governed suite edge then fail-closed security edge', (directSuiteEntry||v43SuiteEntry)&&/import securityEdge from '.\/security-edge\.js'/.test(suite)&&/securityEdge\.fetch/.test(suite));
